...
- `origemResposta` ∈ `humano` · `ia-aceito` · `ia-ajustado` · `""`. Campo da skill, irmão de `origem` e `origemNota`, para a resposta (estratégia + ação + gatilho + residual). Dono nunca entra nessa conta: não é sugerido.
